...
<body class="hero-bg min-h-screen text-white">
    ...
    <nav
        ...
        <div class="max-w-3xl w-full mx-auto flex justify-between items-center">
            <a href="empleos.html"
                class="flex items-center gap-2 text-slate-400 hover:text-white font-bold transition group">
                <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i> Volver a Empleos
            </a>
