...
<body class="hero-bg min-h-screen text-white flex flex-col">
    ...
    <main
        ...
        <!-- Hero Text -->
        <span
            class="px-3 py-1 bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-full text-xs font-bold uppercase tracking-widest mb-6 inline-block">
            v1.8 Release
        </span>
        ...
        <!-- Search Bar Section (New in v1.8) -->
        ...
        <!-- Categories Rectangles (Vertical on Mobile) -->
